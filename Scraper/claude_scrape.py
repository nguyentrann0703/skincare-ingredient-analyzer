...
class PaulaChoiceFullSpider(Spider):
    ...
    concurrency = 2          # ✅ Fix: concurrent_requests -> concurrency
    download_delay = 2.0     # ✅ Thêm: tránh bị block (2 giây giữa các request)
    ...
    def configure_sessions(self, manager):
        ...
        manager.default_session_id = "dynamic"  # ✅ Fix: dùng attribute thay vì set_default()
    ...
    async def parse(self, response: Response):
        ...
        for link in response.css('a[href*="/ingredient-dictionary/"]'):
            ...
            if href and '.html' in href:
                yield Request(href, callback=self.parse_detail)  # ✅ Fix: dùng Request() thay vì response.follow() với callback
        ...
        if next_page:
            ...
            yield Request(next_page, callback=self.parse)  # ✅ Fix: explicit callback
...
if __name__ == "__main__":
    ...
    print(f"📊 Elapsed time: {result.stats.elapsed_time:.2f}s")  # ✅ Dùng elapsed_time (kiểm tra nếu vẫn lỗi)
    print("=" * 80)
