...
class PaulaChoiceFullSpider(Spider):
    ...
    start_urls = [
        ...
        "?csortb1=ingredientNotRated&csortd1=1"
        "&csortb2=ingredientRating&csortd2=2"
        "&csortb3=name&csortd3=1&start=0&sz=100&ajax=true"  # ⚠️ TEST MODE — đổi sz=100 -> sz=2000 khi sẵn sàng scrape full
    ]
    concurrency = 5
    download_delay = 0.5
    ...
    async def parse(self, response: Response):
        ...
        if current_start == 0 and total > 2000:
            base = (
                ...
                "?csortb1=ingredientNotRated&csortd1=1"
                "&csortb2=ingredientRating&csortd2=2"
                "&csortb3=name&csortd3=1&sz=2000&ajax=true"
            )
            print(f"📊 Total: {total} ingredients — generating {total // 2000} more pages...")
